...
<section id="aboutqigong">
    <h1 className="h1-slider marginb4vh">Was ist Qigong</h1>
        <div className="slider">
            <div className="slide_viewer">
                ...
                <div className="slide">
                    ...
                    <img className="DesktopImg" src={Card1Desktop} alt="about-qigong" />
                ...
                <div className="slide-content">
                    ...
                    <img className="DesktopImg" src={Card2Desktop} alt="about-qigong" />
                ...
                <div className="slide-content">
                    ...
                    <img className="DesktopImg" src={Card3Desktop} alt="about-qigong" />
        ...
        <img className="MobileImg" src={Card1} alt="about-qigong" />
    ...
    <img className="MobileImg" src={Card2} alt="about-qigong" />
    <h2 className="mobileh2 centered">
        Card2
    </h2>
    <div className="card-text-mobile centered">
    ...
    <img className="MobileImg" src={Card3} alt="about-qigong" />
    <h2 className="mobileh2 centered">
        Card3
    </h2>
    <div className="card-text-mobile centered">
